      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-4">
          <div className="md:col-span-2">
            ...
            <p className="mt-4 max-w-sm text-sm text-background/80">
            ...
            <div className="mt-6 flex gap-3">
              <a href="https://www.instagram.com/blank2brandedza" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="rounded border border-background/40 p-2 hover:border-primary hover:text-primary">
                <Instagram className="h-4 w-4" aria-hidden="true" />
              </a>
              <a href="https://www.facebook.com/blank2brandedza" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="rounded border border-background/40 p-2 hover:border-primary hover:text-primary">
                <Facebook className="h-4 w-4" aria-hidden="true" />
              </a>
              <a href="https://www.tiktok.com/@blank2brandedza" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="rounded border border-background/40 p-2 hover:border-primary hover:text-primary">
                <Music2 className="h-4 w-4" aria-hidden="true" />
              </a>
              <a href="mailto:hello@blank2branded.co.za" aria-label="Email Blank2Branded" className="rounded border border-background/40 p-2 hover:border-primary hover:text-primary">
        ...
        <div className="mt-12 border-t border-background/20 pt-6 text-xs text-background/75">
